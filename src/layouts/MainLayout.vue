<template>
  <div class="app-main-layout">
    ...
    <ul class="sidenav app-sidenav open">
      <li>
        <a href="/" class="waves-effect waves-orange pointer">Home</a>
      </li>
      <li>
        <a href="/detail" class="waves-effect waves-orange pointer">Счет</a>
      </li>
      <li>
      ...
      <li>
        <a href="/profile" class="waves-effect waves-orange pointer">Profile</a>
      </li>
    </ul>
